...
export const ClientFiltersPanel = ({ filters, onFilterChange, onReset }) => {
  ...
  const activeCount = 
    ...
    (filters?.dateTo ? 1 : 0) +
    (filters?.minOrders ? 1 : 0) +
    (filters?.maxOrders ? 1 : 0);
      ...
      <CollapsibleContent className="pt-4 mt-4 border-t border-slate-100 animate-in slide-in-from-top-2">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Statut du client</Label>
            <Select 
          ...
          {/* Date Range Filter */}
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Date d'inscription</Label>
            <div className="flex items-center gap-2">
              <Input 
                type="date" 
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Nombre de commandes</Label>
            <div className="flex items-center gap-2">
              <Input 
                type="number" 
                placeholder="Min"

        ...
        >
          <div className="text-center mb-4">
            ...
            <h1 className="text-xl font-bold text-white mb-1 drop-shadow-md">
              {mode === 'login' ? 'Espace Personnel Client' : 'Ouvrir un Nouveau Compte'}
            </h1>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl shadow-black/20 p-4">
            ...
            {mode !== 'forgot' && <div className="mt-4 text-center">
              ...
              <div className="mt-4 pt-3 border-t border-gray-100">
                 <SoundLink
                   to="/admin/login"
                   className="inline-flex items-center text-xs font-bold text-gray-400 hover:text-amber-600 transition-colors"
                 >
                   Portail d'Administration <ArrowRight className="ml-1 w-3 h-3" />
                 </SoundLink>
              </div>
            </div>}
          </div>
